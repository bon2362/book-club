  ...
  return (
    ...
    >
      <div
        ...
        className="relative border rounded-xl max-w-[720px] w-full"
        style={{
      ...
      >
        <button
          ...
          onClick={onClose}
          aria-label="Закрыть"
          className="absolute top-3 right-3 h-8 w-8 rounded-full border text-lg leading-none"
          style={{
            borderColor: 'var(--border)',
        ...
        <div className="grid gap-6 p-6" style={{ gridTemplateColumns: '140px minmax(0, 1fr)' }}>
          ...
          <div className="min-w-0">
            <p className="text-base m-0 mb-2" style={{ color: 'var(--text-muted)' }}>
            ...
            {book.tags.length > 0 && (
              <div className="flex flex-wrap gap-1.5 mb-4">
                {book.tags.map((tag) => (
                  <span
                    key={tag}
                    className="text-[11px] uppercase rounded-full px-2 py-0.5 border"
                    style={{
                      color: 'var(--text-muted)',
                      borderColor: 'var(--border)',
                      background: 'var(--bg-elevated)',
            ...
            {book.description && (
              <p
                ...
                style={{ color: 'var(--text-body)', whiteSpace: 'pre-line' }}
              >
                {book.description}
              </p>
            )}
            ...
            {book.whyRead && (
              ...
              >
                ...
                <p className="m-0 text-sm leading-relaxed" style={{ color: 'var(--text-body)', whiteSpace: 'pre-line' }}>
                  {book.whyRead}
                </p>
              </section>
            )}
