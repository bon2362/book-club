  ...
  return (
    <div className="nd-mb-view" data-testid="matching-books-view" aria-busy={pending !== null}>
      <header className="nd-mb-intro">
        ...
        <p>{isAdmin ? 'Здесь можно увидеть и скорректировать актуальные договорённости участников.' : 'Сначала идут книги, вокруг которых уже есть пересечения. Выберите окончательно одну или отметьте несколько подходящих.'}</p>
        {readOnly && !isAdmin && (
