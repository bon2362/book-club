...
/**
 * Единственный книжный попап на доске матчинга: карточки книжной доски зовут
 * `openBook(...)`, а модалка рендерится здесь один раз.
 ...
 *
 * Провайдер монтируется внутри книжной доски и обогащает данные персональным состоянием.
 */
