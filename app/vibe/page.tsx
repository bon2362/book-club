    ...
    >
      ...
      >
        ...
        >
          ...
          книг, режим командного матчинга в реальном времени и инструменты
          организатора.
        </p>
        ...
        <Section title="Статистика кода">
          ...
          >
            <p style={{ ...bodyStyle, fontStyle: 'italic', margin: 0, color: 'var(--text-secondary)' }}>
              1490 unit-тестов (213 suites) + 42 E2E-спецификации (Playwright) — unit покрывают
...
const STACK = [
  ...
  { name: 'Playwright', role: 'E2E-тестирование', desc: '42 spec-файла: авторизация, матчинг, саммари, запись на книги, профиль, layout-тесты и админ-сценарии. Изолированная e2e-ветка Neon, фикстуры с автоматическим cleanup' },
]
...
const RESOURCES = [
  ...
  },
  {
    ...
    desc: 'Интерактивная документация всех 86 API-маршрутов. Спецификация в public/openapi.json',
  },
  {
...
const STATS = [
  { value: '~35 000', label: 'строк кода приложения' },
  { value: '86', label: 'API-маршрутов' },
  { value: '1490', label: 'unit-тестов' },
  { value: '42', label: 'E2E-спецификации' },
]

const CODE_ROWS = [
  { category: 'UI-компоненты (страницы, drawer, карточки, формы)', lines: 20000 },
  { category: 'API-маршруты и серверные страницы', lines: 5000 },
  { category: 'Тесты (unit + E2E)', lines: 54800 },
  { category: 'Бизнес-логика (auth, матчинг, аудит, БД, email)', lines: 10200 },
  { category: 'Конфигурация и инфраструктура', lines: 600 },
]
