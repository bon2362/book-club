        ...
        <Section title="Статистика кода">
          ...
          >
            <p style={{ ...bodyStyle, fontStyle: 'italic', margin: 0, color: 'var(--text-secondary)' }}>
              ...
              примерно равные доли — примерно по 11–12% каждая. Тесты покрывают
...
const FEATURES = [
  ...
  { title: 'Вход через Google или email', desc: 'Google OAuth или магическая ссылка на почту — без паролей и отдельной регистрации' },
  ...
  { title: 'Панель администратора', desc: 'Три вкладки: участники с контактами, книги с числом и именами записавшихся, теги с редактором описаний' },
...
const STACK = [
  ...
  { name: 'Resend', role: 'Вход через email', desc: 'Отправляет магическую ссылку на почту — альтернатива Google-входу для тех, кто предпочитает email' },
...
const STATS = [
  { value: '~3 200', label: 'строк кода' },
  { value: '14', label: 'реализованных функций' },
  { value: '7', label: 'сервисов и технологий' },
  { value: '2', label: 'способа входа' },
]

const CODE_ROWS = [
  { category: 'UI-компоненты (страницы, карточки, формы, хедер)', lines: 2000 },
  { category: 'Бизнес-логика (Sheets, авторизация, БД, поиск)', lines: 380 },
  { category: 'API-маршруты и серверные страницы', lines: 360 },
