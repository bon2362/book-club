...
const USER_FEATURES = [
  ...
  {
    title: 'Добавление книги в список',
    desc: 'Одним кликом, с обязательным выбором приоритета — участие в матчинге гарантировано для каждой добавленной книги. Счётчик «хотят читать» на каждой карточке, читательские круги показывают, кто ещё хочет читать ту же книгу',
  },
  {
  ...
  },
  {
    ...
    desc: 'Drawer справа: вкладки «Хочу читать», «Предложил:а», «Профиль». Редактирование имени и Telegram, языковые предпочтения, история заявок на книги',
  },
  {
