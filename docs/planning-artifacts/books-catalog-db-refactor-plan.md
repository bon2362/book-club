...
## Этап 3. Переключить пользовательские связи на `book_id`
...
## Этап 8. Удалить legacy `session` table
...
## Этап 9. Удалить legacy `account` table
...
## Этап 10. Финальная чистка тестов и документации
...
### PR 3. Switch signup/priorities runtime to `book_id`
...
### PR 7. Remove unused DB session table
...
### PR 8. Remove Auth.js account table
