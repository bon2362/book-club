...
Не подсвечивать карточки в `Читательских кругах` при наведении на `Мои ходы`: на реальных данных это слишком часто подсвечивает почти весь список и не помогает принять решение. Связь хода со сценарием должна объясняться внутри самой карточки хода через прогноз будущего лидер-сценария.
