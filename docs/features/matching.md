...
Актуальный matching — единый satisfaction flow с реальными именами, временными подтверждениями и закреплением единогласных кругов. Исторический runtime сохранён только git-тегом `matching-legacy-before-simplification-2026-06-29`.
