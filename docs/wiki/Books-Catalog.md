...
На главной порядок крупных блоков такой: шапка, при необходимости полоса активного матчинга, «Что это», включённый владельцем блок «Подборки», затем поиск и фильтры каталога и сам список книг. Блок подборок не меняет состав каталога и скрывается переключателем в админ-панели.
