...
В самой карточке хода остаётся короткое текстовое объяснение. Например: «Муравей уже в сценарии, но эту книгу хотят сильнее. Добавишь — соберутся вокруг неё, не потеряв покрытие». Блок «Кому это поможет» больше не используется: состав нового сценария виден в preview слева.
