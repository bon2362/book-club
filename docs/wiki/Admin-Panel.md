...
| Матчинг | Создавать, закрывать и повторно открывать сессии, управлять размером групп, участниками и книжными назначениями, смотреть аналитику событий. |

## Матчинг

Администратор видит реальные имена, источник вступления (`self`/`admin`), online и роль участника (`active`/`observer`). Принудительное добавление сохранено для тестирования; интерфейс предупреждает, что оно обходит личный экран disclosure. Книжные назначения и круги редактируются через книжные admin-actions.
