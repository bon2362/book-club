...
Секция «Аналитика изменений предпочтений» читает `matching_events`: действия с книгами и рангами, вступление/выход, подтверждения, автоматические переносы, закрепления, роспуск и freeze. В глобальной «Истории изменений» те же операции видны как технические before/after записи audit log.
