...
| Вкладка | Назначение |
| --- | --- |
| Участники | Видеть пользователей, контакты, выбранные книги, языки, активность, сразу видеть бейдж «Читает» у тех, кто сейчас читает хотя бы одну книгу, искать по имени/Telegram, удалять пользователя или сливать дубль в основной аккаунт. |
