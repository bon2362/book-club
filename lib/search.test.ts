...
const books: Book[] = [
  ...
  { id: '2', name: 'Как богатые страны стали богатыми', author: 'Erik S. Reinert', tags: ['модернизация'],
    type: 'Book', size: 'L', pages: '384', date: '2021', link: '', description: '', coverUrl: null, whyForClub: null, recommendationLink: null },
  { id: '3', name: 'Democratic Theory', author: 'Grigoriy Yudin', tags: ['демократия'],
    type: 'Book', size: 'M', pages: '200', date: '2022', link: '', description: '', coverUrl: null, whyForClub: null, recommendationLink: null },
]
