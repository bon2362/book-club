...
- Согласование времени встречи круга по календарю доступности. Идея интерфейса вдохновлена опен-сорс решением **[avails](https://github.com/Citizen-Infra/avails)**. Код avails при этом не переиспользован
